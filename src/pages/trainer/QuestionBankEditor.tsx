  ...
  if (!qualGuard || !unitId) {
    return (
      <div className="text-center py-20 text-muted-foreground flex flex-col items-center gap-4">
        ...
        <Link to="/trainer/question-bank" className="text-primary font-bold text-xs ring-offset-background hover:underline mt-2">
    ...
    return (
      <div className="max-w-md mx-auto py-24 text-center space-y-6">
        ...
        <Button asChild variant="outline">
          <Link to="/trainer/question-bank" className="gap-2">
